...
/**
 * Validates SEP-9 customer KYC fields according to Stellar specifications.
 * Ensures fields use snake_case and correct enums.
 */
export class Sep9ValidationService {
  static validate(payload: Record<string, any>): Sep9ValidationResult {
    ...
    // Check for camelCase keys and unknown fields
    ...
    // In SEP-12, partial updates are allowed. We only validate formats of fields if they exist.
