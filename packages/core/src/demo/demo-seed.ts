...
const envConfig = envSchema.safeParse(process.env).data || {};
const mockConfigService = {
  get: (key: string) => envConfig[key as keyof typeof envConfig],
};
const envService = new EnvService(mockConfigService as any);
const encryptionService = new EncryptionService(envService);
